...
if(!User::logged()) if(Request::cook("USER")) Request::sess("USER",Request::cook("USER"));?>
<!DOCTYPE html>
<html lang="pt-BR">
    <head>
    ...
    <body class="-fregular" style="font-size:14px;background:#2C2F2F;min-width:1080px;overflow-x:hidden;color:white;padding:0;margin:0;">
        <?php
        if(Core::get('uri')){
